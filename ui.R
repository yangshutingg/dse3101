...
ui <- fluidPage(
  tags$head(
    tags$style(HTML(".main-container, .tab-content {
      flex-grow: 1;
      display: flex;
    ...
    #benchmark_stats, #chosen_model_stats, #pct_signs_wrong {
      margin-bottom: 20px; 
...
table>thead>tr>th, .table>thead>tr>th, table>tbody>tr>th, .table>tbody>tr>th, table>tfoot>tr>th, .table>tfoot>tr>th, table>thead>tr>td, .table>thead>tr>td, table>tbody>tr>td, .table>tbody>tr>td, table>tfoot>tr>td, .table>tfoot>tr>td { 
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p("ADL: regression model in which GDP growth rate is regressed against its previous values & previous values of real personal consumption and treasury yield spread"),
